...
var argumentMess = {
	...
	messer: function messer(a, b, c) {
		console.log((typeof a === 'undefined' ? 'undefined' : _typeof(a)) == (typeof b === 'undefined' ? 'undefined' : _typeof(b)) ? this.greeting : this.greeting + ' messed');
	},
	equator: function equator() {
		var args = Array.prototype.slice.apply(arguments); // using slice to convert array-like object(arguments) to an array
		console.log(args.findIndex(function (x) {
			return x === 343;
		}));
	}
};
